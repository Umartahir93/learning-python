# =========== I have Taken this py from "python for everybody" exercise ================
# =========== Walk through the code its just cleaning the data and most of code is done by me in previous exercise   ============
# =========== Since two of tables were missing with data from db so I downloaded mapping.sqlite from his p4e and placed it here ============
